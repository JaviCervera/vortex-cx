...
#g++ -std=c++03 -stdlib=libstdc++ -O2 -m32 -read_only_relocs suppress -shared -o meshtool.data/loadmesh.dylib -DBUILD_SHARED src_meshtool/loadmesh.cc -Lsrc_meshtool/irrlicht -lIrrlicht.mac -framework AppKit -framework IOKit -framework OpenGL
