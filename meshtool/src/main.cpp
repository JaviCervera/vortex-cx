...
private:
	...
	scene::IAnimatedMesh* mMesh = nullptr;
	scene::IAnimatedMeshSceneNode* mNode = nullptr;
	scene::ICameraSceneNode* mCam = nullptr;
	std::string mLastFilename = "";
	bool mExportMaterials = true;
	bool mExportNormals = true;
	bool mExportTangents = true;
	bool mExportAnimations = true;
};
...
int main(int, char**) {
	...
	toolbar->addButton(BUTTON_OPEN, nullptr, L"Open Mesh", device->getVideoDriver()->getTexture("data/folder.png"), nullptr, false, true);
	toolbar->addButton(BUTTON_SAVEXML, nullptr, L"Save XML Mesh", device->getVideoDriver()->getTexture("data/xhtml.png"), nullptr, false, true);
