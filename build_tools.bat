...
g++ -std=c++03 -w -O2 -m32 -o meshtool.exe src.meshtool/main.cpp src.meshtool/mesh.cpp -Lsrc.meshtool/irrlicht -lirrlicht.win32 -lgdi32 -lwinmm -lopengl32 -mwindows
